...
namespace Persistence.Migrations
{
    ...
    [Migration("20220925214601_sales-creation")]
    partial class salescreation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Coupon", b =>
                {
                    ...
                    b.Property<bool>("HasValidity")
                        .HasColumnType("boolean")
                        .HasColumnName("has_validity");
                    ...
                    b.ToTable("etk_coupons");
                });

            modelBuilder.Entity("Domain.Entities.CouponCustomer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("ValueRemaining")
                        .HasColumnType("numeric")
                        .HasColumnName("value_remaining");
                    ...
                    b.ToTable("etk_customer_coupons");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sale", b =>
                {
                    ...
                    b.Property<Guid?>("CouponCustomerId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("Shipping")
                        .HasColumnType("numeric")
                        .HasColumnName("vl_shipping");

                    b.HasKey("Id");

                    b.HasIndex("AddressId");

                    b.HasIndex("CouponCustomerId");
            ...
            modelBuilder.Entity("Domain.Entities.SaleCoupon", b =>
                {
                    ...
                    b.Property<Guid>("CouponCustomerId")
                        .HasColumnType("uuid")
                        .HasColumnName("customer_coupon_id");

                    b.Property<decimal>("DiscountValue")
                        .HasColumnType("numeric")
                        .HasColumnName("vl_discount");

                    b.HasKey("SaleId", "CouponCustomerId");

                    b.HasIndex("CouponCustomerId");

                    b.ToTable("etk_sale_coupons");
                });
            ...
            modelBuilder.Entity("Domain.Entities.SalePayment", b =>
                {
                    ...
                    b.Property<decimal>("ValuePaid")
                        .HasColumnType("numeric")
                        .HasColumnName("vl_paid");

                    b.HasKey("SaleId", "CreditCardId");

                    b.HasIndex("CreditCardId");

                    b.ToTable("etk_sale_payments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.CouponCustomer", null)
                        .WithMany("Sales")
                        .HasForeignKey("CouponCustomerId");
            ...
            modelBuilder.Entity("Domain.Entities.SaleCoupon", b =>
                {
                    b.HasOne("Domain.Entities.CouponCustomer", "CouponCustomer")
                        .WithMany()
                        .HasForeignKey("CouponCustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Domain.Entities.Sale", "Sale")
                        .WithMany("SaleCoupons")
                        .HasForeignKey("SaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CouponCustomer");
